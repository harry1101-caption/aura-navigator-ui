    ...
    <div className="min-h-[400px]">
      {goals.map((goal) => (
        <div key={goal.id}>
          {/* Goal row */}
          <div
            className="flex items-center h-16 border-b px-4 py-3 hover:bg-gray-50 cursor-pointer"
          ...
          {goal.expanded &&
            goal.milestones.map((milestone) => (
              <div
                key={milestone.id}
                className="flex items-center h-16 border-b px-4 py-3 pl-10 bg-gray-50 hover:bg-gray-100"
              >
